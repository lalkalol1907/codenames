...
object Messages {
    ...
    private val exceptionKeys = mapOf(
        ...
        "Between 4 and 8 active players required for random teams" to "error.randomize_players_range",
        "Player not in room" to "error.player_not_in_room",
        "Role already taken" to "error.role_taken",
        "Team already has maximum operatives" to "error.max_operatives",
        "At least 4 players required" to "error.min_players",
        "Each team needs exactly 1 spymaster and 1 operative" to "error.team_roles",
        "Each team needs 1 spymaster and 1 to 3 operatives" to "error.team_roles_range",
